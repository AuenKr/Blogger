...
import worker from "/media/auenkr/New Volume F/Project/medium/backend/.wrangler/tmp/bundle-VGnbbT/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/media/auenkr/New Volume F/Project/medium/backend/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/media/auenkr/New Volume F/Project/medium/backend/.wrangler/tmp/bundle-VGnbbT/middleware-insertion-facade.js";
